...
(234,'app mobile','2026-01-01','2026-03-10',2),
(98,'site web','2025-10-02','2026-12-01',4),
(123,'site-ecommerce beauty','2026-02-10','2026-05-01',1);
...
select * 
from proget 
where date-fin < 2026-04-01;

-- les employés développeurs--
select *
from employe 
where poste = 'developper';
